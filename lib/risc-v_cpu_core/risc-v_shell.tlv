...
\TLV
   ...
   // Get value for immediate using MUX logic
   ...
   *failed = *cyc_cnt > M4_MAX_CYC;
   ...
   m4+rf(32, 32, $reset, $wr_en, $rd[4:0], $result[31:0], $rd_en1, $rs1[4:0], $src1_value, $rd_en2, $rs2[4:0], $src2_value)
